...
Source Database       : minigucixie

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2017-09-15 14:41:45
*/
...
CREATE TABLE `lr_address` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户收货地址表';

-- ----------------------------
-- Records of lr_address
-- ----------------------------
INSERT INTO `lr_address` VALUES ('1', '李嘉欣', '13500002266', '2151', '2152', '2157', '科韵路黄埔大道中', '广东省 广州市 天河区 科韵路黄埔大道中', '440106', '3', '0');
INSERT INTO `lr_address` VALUES ('2', '测试', '1350000000', '43', '85', '88', '的挂号信复合型出第三方官方闪电发货', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '3', '1');
...
CREATE TABLE `lr_attribute` (
  ...
  `pro_id` int(11) DEFAULT '0' COMMENT '产品ID',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `lr_attribute` VALUES ('1', '颜色', '1501480206', '279');
INSERT INTO `lr_attribute` VALUES ('2', '尺寸', '1501480206', '279');
INSERT INTO `lr_attribute` VALUES ('3', '颜色', '1501487712', '273');
INSERT INTO `lr_attribute` VALUES ('4', '颜色', '1501902603', '6');
INSERT INTO `lr_attribute` VALUES ('5', '尺寸', '1501902603', '6');
INSERT INTO `lr_attribute` VALUES ('6', '颜色', '1501913955', '5');
INSERT INTO `lr_attribute` VALUES ('7', '尺寸', '1501913955', '5');
...
-- Records of lr_brand
-- ----------------------------
INSERT INTO `lr_brand` VALUES ('1', '懒洋洋软体鞋', 'UploadFiles/brand/20170802/1501639251997932.png', '0', '1501639251', '0');
...
-- ----------------------------
INSERT INTO `lr_category` VALUES ('1', '0', '产品一级分类（系统分类）', '0', '0', '', '', null, '', '0', null);
INSERT INTO `lr_category` VALUES ('2', '1', '骨刺鞋', '1', '1501637466', '骨刺鞋', '', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('3', '1', '鞋垫', '2', '1501637488', '鞋垫', '', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('4', '2', '减痛鞋', '1', '1501638075', '骨刺低帮鞋', 'UploadFiles/category/20170802/1501638075771502.png', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('5', '2', '远足鞋', '2', '1501638171', '骨刺远足鞋', 'UploadFiles/category/20170802/1501646634851310.png', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('6', '2', '凉鞋', '3', '1501638204', '骨刺凉鞋', 'UploadFiles/category/20170802/1501638204106185.png', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('7', '2', '休闲鞋', '4', '1501638246', '骨刺休闲鞋', 'UploadFiles/category/20170802/1501638246524607.png', null, null, '0', null);
INSERT INTO `lr_category` VALUES ('8', '3', '骨刺鞋垫', '1', '1501638266', '骨刺鞋垫', 'UploadFiles/category/20170802/1501638266851419.png', null, null, '0', null);

-- ----------------------------
-- Table structure for `lr_catimg`
-- ----------------------------
DROP TABLE IF EXISTS `lr_catimg`;
CREATE TABLE `lr_catimg` (
  ...
  `img_str` text COMMENT '推荐图片',
  `addtime` int(11) DEFAULT '0' COMMENT '添加时间',
  `state` tinyint(2) DEFAULT '1' COMMENT '状态，1正常 0取消推荐',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_catimg
-- ----------------------------
INSERT INTO `lr_catimg` VALUES ('1', '6', '7', ',UploadFiles/product/category/20170804/1501811247248554.jpg,UploadFiles/product/category/20170804/1501811250927356.jpg', '1501811250', '1');
INSERT INTO `lr_catimg` VALUES ('2', '1', '4', ',UploadFiles/product/category/20170804/1501816937182712.jpg', '1501816937', '1');
INSERT INTO `lr_catimg` VALUES ('3', '5', '5', ',UploadFiles/product/category/20170804/1501817262531129.jpg,UploadFiles/product/category/20170804/1501817262124228.jpg', '1501817262', '1');
...
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('5', '首页轮播', 'UploadFiles/adv/20170904/1504489030639098.png', '0', '1000', '', '53', '1');
INSERT INTO `lr_guanggao` VALUES ('8', '首页轮播', 'UploadFiles/adv/20170904/1504489037791782.jpg', '0', '0', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('10', '首页轮播', 'UploadFiles/adv/20170904/1504489017642090.png', '1493349922', '0', '', '13', '1');
...
-- Records of lr_guige
-- ----------------------------
INSERT INTO `lr_guige` VALUES ('1', '279', '1', '卡其色', '190.00', '99', 'UploadFiles/attribute/20170731/1501480303329500.jpg', '1501480206');
INSERT INTO `lr_guige` VALUES ('2', '279', '1', '天蓝色', '199.00', '90', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('3', '279', '1', '咖啡色', '198.00', '100', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('4', '279', '2', 'M', '197.00', '97', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('5', '279', '2', 'S', '196.00', '96', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('6', '279', '2', 'L', '195.00', '95', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('7', '279', '2', 'XL', '194.00', '94', null, '1501480206');
INSERT INTO `lr_guige` VALUES ('8', '273', '3', '咖啡色', '0.70', '17', null, '1501487712');
INSERT INTO `lr_guige` VALUES ('9', '273', '3', '酒红色', '0.70', '17', null, '1501487712');
INSERT INTO `lr_guige` VALUES ('10', '273', '3', '军绿色', '0.70', '17', null, '1501487712');
INSERT INTO `lr_guige` VALUES ('11', '273', '3', '天蓝色', '0.70', '17', null, '1501487712');
INSERT INTO `lr_guige` VALUES ('12', '273', '3', '卡其色', '0.70', '17', null, '1501487712');
INSERT INTO `lr_guige` VALUES ('13', '6', '4', '白色', '749.00', '9', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('14', '6', '4', '黑色', '729.00', '93', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('15', '6', '5', '35', '739.00', '94', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('16', '6', '5', '36', '740.00', '95', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('17', '6', '5', '37', '741.00', '96', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('18', '6', '5', '38', '742.00', '97', null, '1501902603');
INSERT INTO `lr_guige` VALUES ('19', '6', '5', '39', '745.00', '100', null, '1501902638');
INSERT INTO `lr_guige` VALUES ('25', '5', '6', '白色', '838.00', '349', null, '1501914314');
INSERT INTO `lr_guige` VALUES ('26', '5', '6', '黑色', '838.00', '349', null, '1501914314');
INSERT INTO `lr_guige` VALUES ('27', '5', '7', '36', '838.00', '349', null, '1501914314');
INSERT INTO `lr_guige` VALUES ('28', '5', '7', '37', '838.00', '349', null, '1501914314');
INSERT INTO `lr_guige` VALUES ('29', '5', '7', '38', '838.00', '349', null, '1501914314');
INSERT INTO `lr_guige` VALUES ('30', '5', '7', '39', '838.00', '349', null, '1501914314');
...
-- ----------------------------
INSERT INTO `lr_indeximg` VALUES ('3', '0', '积分兑换', 'UploadFiles/category/20170904/1504492835502568.png', '3', 'jifen', 'other');
INSERT INTO `lr_indeximg` VALUES ('2', '0', '当季新品', 'UploadFiles/category/20170904/1504492842321854.jpg', '2', 'newpro', 'other');
INSERT INTO `lr_indeximg` VALUES ('1', '0', '全部商品', 'UploadFiles/category/20170904/1504492851772853.png', '1', 'allpro', 'other');
INSERT INTO `lr_indeximg` VALUES ('4', '0', '品牌故事', 'UploadFiles/category/20170904/1504492863757124.jpg', '4', 'brand', 'other');

-- ----------------------------
-- Table structure for `lr_indexpro`
-- ----------------------------
DROP TABLE IF EXISTS `lr_indexpro`;
CREATE TABLE `lr_indexpro` (
  ...
  `fontsize` char(10) DEFAULT NULL COMMENT '字体大小',
  `fontcolor` char(10) DEFAULT NULL COMMENT '字体颜色',
  `introsize` char(10) DEFAULT NULL COMMENT '广告词大小',
  `introcolor` char(10) DEFAULT NULL COMMENT '公司词颜色',
  `type` char(20) DEFAULT NULL COMMENT '跳转事件',
  `val` char(10) DEFAULT NULL COMMENT '跳转值',
  `sort` int(11) DEFAULT '0' COMMENT '排序',
  `state` tinyint(2) DEFAULT '1' COMMENT '显示状态 1正常  0隐藏',
  `addtime` int(11) DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of lr_indexpro
-- ----------------------------
INSERT INTO `lr_indexpro` VALUES ('1', '6', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '专利鞋底 减震优良 里外全真皮', '40rpx', '', '35rpx', '', 'pro', '6', '1', '1', '1502439256');
INSERT INTO `lr_indexpro` VALUES ('2', '5', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '专利软底休闲潮款 真皮 脚痛福音', '40rpx', 'red', '35rpx', '', 'procat', '5', '2', '1', '1502439347');
INSERT INTO `lr_indexpro` VALUES ('3', '1', '懒洋洋真皮软底单鞋女夏厚底中跟职业女鞋休闲鞋浅口牛皮鞋骨刺鞋', '专利软底全真皮 减缓骨刺脚痛', '40rpx', '#CCCCCC', '35rpx', '#CCCCCC', 'pro', '1', '3', '1', '1502439283');
INSERT INTO `lr_indexpro` VALUES ('4', '3', '懒洋洋春夏真皮小白鞋英伦风布洛克平跟休闲鞋软底女单鞋骨刺鞋', '减震护脚 真皮软底', '40rpx', '#000000', '', '', '', '', '4', '1', '1502439291');
...
CREATE TABLE `lr_order` (
  ...
  `order_type` tinyint(2) DEFAULT '1' COMMENT '订单类型 1普通订单',
  PRIMARY KEY (`id`)
...
-- Records of lr_order
-- ----------------------------
INSERT INTO `lr_order` VALUES ('1', '2017080454485057', null, '0', '3', '2336.00', '2336.00', '1501829574', '0', 'weixin', '0.00', '20', '0', '测试', '1350000000', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '0', '测试下单', '', '3', null, null, null, '2', '没有原因', '1501895560', '1');
INSERT INTO `lr_order` VALUES ('2', '2017080510054525', null, '0', '3', '749.00', '749.00', '1501918557', '0', 'weixin', '0.00', '0', '0', '李嘉欣', '13500002266', '广东省 广州市 天河区 科韵路黄埔大道中', '440106', '0', '属性测试', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('3', '2017090457579957', null, '0', '3', '222.00', '222.00', '1504506297', '0', 'weixin', '0.00', '0', '0', '李嘉欣', '13500002266', '广东省 广州市 天河区 科韵路黄埔大道中', '440106', '0', '', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('4', '2017090410010110', null, '0', '3', '666.00', '666.00', '1504506397', '0', 'weixin', '0.00', '0', '0', '李嘉欣', '13500002266', '广东省 广州市 天河区 科韵路黄埔大道中', '440106', '0', '', '', '2', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('5', '2017090452575155', null, '0', '3', '739.00', '739.00', '1504506772', '0', 'weixin', '0.00', '0', '0', '李嘉欣', '13500002266', '广东省 广州市 天河区 科韵路黄埔大道中', '440106', '0', '', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('6', '2017090456101529', null, '0', '3', '838.00', '838.00', '1504513736', '0', 'weixin', '0.00', '10', '0', '测试', '1350000000', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '0', '', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('7', '2017090451579710', null, '0', '3', '1825.00', '1492.00', '1504518307', '0', 'weixin', '0.00', '40', '2', '测试', '1350000000', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '0', '', '', '5', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('8', '2017090655534953', null, '0', '3', '4064.00', '4064.00', '1504659751', '0', 'weixin', '0.00', '40', '0', '测试', '1350000000', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '0', '', '', '6', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('9', '2017090653100511', null, '0', '3', '838.00', '838.00', '1504664741', '0', 'weixin', '0.00', '40', '0', '测试', '1350000000', '河北省 秦皇岛市 山海关区 的挂号信复合型出第三方官方闪电发货', '130303', '0', '', '', '1', null, null, null, '0', null, '0', '1');
...
-- ----------------------------
INSERT INTO `lr_order_product` VALUES ('1', '6', '1', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '749.00', 'UploadFiles/product/20170802/1501656677376142.jpg', '', '1501829574', '2', '');
INSERT INTO `lr_order_product` VALUES ('2', '5', '1', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '838.00', 'UploadFiles/product/20170802/1501653120620916.jpg', '', '1501829574', '1', '');
INSERT INTO `lr_order_product` VALUES ('3', '6', '2', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '749.00', 'UploadFiles/product/20170802/1501656677376142.jpg', '黑色,36', '1501918557', '1', '');
INSERT INTO `lr_order_product` VALUES ('4', '8', '3', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '222.00', 'UploadFiles/product/20170802/1501653120620916.jpg', 'undefined', '1504506297', '1', '');
INSERT INTO `lr_order_product` VALUES ('5', '9', '4', '懒洋洋春夏真皮小白鞋英伦风布洛克平跟休闲鞋软底女单鞋骨刺鞋', '333.00', 'UploadFiles/product/20170802/1501645735572802.jpg', 'undefined', '1504506397', '2', '');
INSERT INTO `lr_order_product` VALUES ('6', '6', '5', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '739.00', 'UploadFiles/product/20170802/1501656677376142.jpg', '黑色,35', '1504506772', '1', '');
INSERT INTO `lr_order_product` VALUES ('7', '5', '6', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '838.00', 'UploadFiles/product/20170802/1501653120620916.jpg', '白色,36', '1504513736', '1', '');
INSERT INTO `lr_order_product` VALUES ('8', '11', '7', '懒洋洋真皮软底单鞋女夏厚底中跟职业女鞋休闲鞋浅口牛皮鞋骨刺鞋', '365.00', 'UploadFiles/product/20170802/1501641458725702.jpg', 'undefined', '1504518307', '5', '');
INSERT INTO `lr_order_product` VALUES ('9', '12', '8', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '444.00', 'UploadFiles/product/20170802/1501656677376142.jpg', 'undefined', '1504659751', '1', '');
INSERT INTO `lr_order_product` VALUES ('10', '5', '8', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '838.00', 'UploadFiles/product/20170802/1501653120620916.jpg', '黑色,37', '1504659751', '2', '');
INSERT INTO `lr_order_product` VALUES ('11', '1', '8', '懒洋洋真皮软底单鞋女夏厚底中跟职业女鞋休闲鞋浅口牛皮鞋骨刺鞋', '648.00', 'UploadFiles/product/20170802/1501641458725702.jpg', 'undefined', '1504659751', '3', '');
INSERT INTO `lr_order_product` VALUES ('12', '5', '9', '懒洋洋软底真皮高帮鞋厚底女鞋坡跟舒适休闲运动鞋慢步鞋骨刺鞋', '838.00', 'UploadFiles/product/20170802/1501653120620916.jpg', '白色,39', '1504664741', '1', '');
...
CREATE TABLE `lr_product` (
  ...
  `is_hottype` tinyint(2) DEFAULT '0' COMMENT '热推',
  `del` tinyint(2) NOT NULL DEFAULT '0' COMMENT '删除状态',
...
-- ----------------------------
INSERT INTO `lr_product` VALUES ('1', '0', '1', '懒洋洋真皮软底单鞋女夏厚底中跟职业女鞋休闲鞋浅口牛皮鞋骨刺鞋', '专利软底全真皮 减缓骨刺脚痛', '0906B', '1080.00', '648.00', '0', 'UploadFiles/product/20170802/1501641458725702.jpg', 'UploadFiles/product/20170802/1501641458790677.jpg', null, '<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037011452.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037013013.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037028838.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037021023.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037027009.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037023050.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021
jpg', null, '<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021056227820.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021056229557.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021056228188.jpg\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021056357106.png\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021057461176.jpg\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021058093173.jpg\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021058278584.png\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021058456731.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021058452496.jpg\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021059036872.png\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021059034823.png\" alt=\"\" width=\"100%\" />', '1504501742', '1504501742', '0', '0', '0', '999999', '1', '0', '1', '1504514237', '0', null, '4', '双', '1', '0', '0', '2', null, null);
INSERT INTO `lr_product` VALUES ('11', '0', '1', '懒洋洋真皮软底单鞋女夏厚底中跟职业女鞋休闲鞋浅口牛皮鞋骨刺鞋', '专利软底全真皮 减缓骨刺脚痛', '0906B', '1080.00', '365.00', '0', 'UploadFiles/product/20170802/1501641458725702.jpg', 'UploadFiles/product/20170802/1501641458790677.jpg', null, '<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037011452.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037013013.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037028838.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037021023.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037027009.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037023050.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021037021141.png\" alt=\"\" width=\"100%\" />', '1504501754', '1504501754', '0', '0', '5', '-5', '1', '0', '1', '1504514235', '0', null, '4', '双', '1', '0', '0', '2', null, null);
INSERT INTO `lr_product` VALUES ('12', '0', '1', '懒洋洋春秋软底真皮高帮女士短靴菱格纹舒适时尚单靴内增高踝靴子', '专利鞋底 减震优良 里外全真皮 ', '0031-5', '1499.00', '444.00', '0', 'UploadFiles/product/20170802/1501656677376142.jpg', 'UploadFiles/product/20170802/1501656678662816.jpg', ',UploadFiles/product/20170803/1501749967858283.jpg,UploadFiles/product/20170803/1501749967629132.jpg,UploadFiles/product/20170803/1501749967303846.jpg', '<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021449087013.png\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450124631.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450128937.jpg\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450424818.png\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450437489.png\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450434648.png\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450436915.png\" alt=\"\" width=\"100%\" /><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450582440.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450581266.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450589992.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450586214.jpg\" alt=\"\" width=\"100%\" />&nbsp;<img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170802/201708021450583736.jpg\" alt=\"\" width=\"100%\" />', '1504514255', '1504514255', '0', '0', '1', '999998', '1', '0', '0', '0', '0', null, '7', '双', '1', '0', '0', '2', '1504515600', '1504602000');
...
-- ----------------------------
INSERT INTO `lr_product_dp` VALUES ('16', '3', '12', '8', '0', '很好，非常好', '1504679092', '1', '1', '谢谢', '1504685919');
INSERT INTO `lr_product_dp` VALUES ('14', '3', '12', '8', '5', '哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈', '1504668971', '1', '1', '感谢您的好评', '1504677363');
INSERT INTO `lr_product_dp` VALUES ('15', '3', '12', '8', '2', '嘻嘻嘻嘻嘻嘻', '1504668982', '1', '1', '滚滚滚。。。。。。', '1504685933');
INSERT INTO `lr_product_dp` VALUES ('17', '3', '5', '9', '1', '哈哈', '1504850366', '1', '1', '嘻嘻', '1504857715');
...
-- ----------------------------
INSERT INTO `lr_product_sc` VALUES ('4', '6', '3', '1');
...
-- ----------------------------
INSERT INTO `lr_search_record` VALUES ('1', '3', '真皮', '40', '1501818408');
INSERT INTO `lr_search_record` VALUES ('2', '3', '鞋子', '2', '1501900001');
INSERT INTO `lr_search_record` VALUES ('3', '3', '靴子', '1', '1501900289');
INSERT INTO `lr_search_record` VALUES ('4', '3', '高帮鞋', '1', '1501900608');
INSERT INTO `lr_search_record` VALUES ('5', '3', '高帮鞋女士', '2', '1501900619');
INSERT INTO `lr_search_record` VALUES ('6', '3', '子', '1', '1504517494');
INSERT INTO `lr_search_record` VALUES ('7', '3', '懒', '2', '1504517503');
...
-- ----------------------------
INSERT INTO `lr_shopping_char` VALUES ('1', '6', '749.00', '9', '白色,36', '1502337207', '2', '0', '1');
INSERT INTO `lr_shopping_char` VALUES ('2', '6', '739.00', '1', '黑色,35', '1502347016', '2', '0', '1');
INSERT INTO `lr_shopping_char` VALUES ('3', '6', '749.00', '1', '白色,37', '1502439423', '2', '0', '1');
...
-- Records of lr_user
-- ----------------------------
INSERT INTO `lr_user` VALUES ('1', 'aa', 'aa', 'aa', '0', '200', null, null, '0', null, '0', '0', '', '', '0');
INSERT INTO `lr_user` VALUES ('2', '小伙伴', '小伙伴', '', '1494210088', '200', 'http://wx.qlogo.cn/mmopen/vi_32/6Dq9DIIcGyQiaEA4JicN48rEQ1bwm33s2cGkzHlSLkUOPwktluYXmf84fiaILKMUCb5SSvOHmxxenE4MlelQhibBqg/0', null, '0', null, '1', '0', 'oQukL0fa013osRbWSdIPaUt88JZE', 'wx', '0');
INSERT INTO `lr_user` VALUES ('3', '小伙伴', '小伙伴', '', '1496195940', '145', 'http://wx.qlogo.cn/mmhead/icXtjp9jsR5RylwDhXjxFtIL70hvKaibowUZYFsD9shibBiaQyqvD1zRng/132', '', '0', null, '1', '0', 'undefined', 'wx', '0');
...
-- ----------------------------
INSERT INTO `lr_user_voucher` VALUES ('5', '3', '2', '0', '999.00', '333.00', '1504368000', '1506009599', '1504507509', '1');
...
-- ----------------------------
INSERT INTO `lr_voucher` VALUES ('2', '0', '优惠', '999.00', '333.00', '1504368000', '1506009599', '55', '11', '2', '1504505494', '1', '0', 'all');
...
CREATE TABLE `lr_web` (
  ...
  `ename` varchar(100) DEFAULT NULL COMMENT '上传文件路径',
  `linkurl` varchar(200) DEFAULT NULL COMMENT '链接',
  `photo` varchar(100) DEFAULT NULL COMMENT '展示图',
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
...
-- Records of lr_web
-- ----------------------------
INSERT INTO `lr_web` VALUES ('1', '0', '关于我们', '', null, null, '0', '<p></p><p><span style=\"font-family:宋体;font-size:10.5000pt;\"><img src=\"/minigucixie/Data/UploadFiles/Uploads/day_170803/201708031142575992.jpg\" alt=\"\" /><br /></span></p><p><span style=\"font-family:宋体;font-size:10.5000pt;\">手机号码：1501457425</span></p><p><span style=\"font-family:宋体;font-size:10.5000pt;\">电话号码：020-258745</span></p><p><span style=\"font-family:宋体;font-size:10.5000pt;\"><span style=\"font-family:宋体;\">店铺地址：广州市荔湾区中山八路荔湖大厦南座2楼B2048档</span></span></p><br />', '1504495271');
INSERT INTO `lr_web` VALUES ('3', '0', '首页视频管理', 'UploadFiles/vedio/20170802/vedio_5171501667394.mp4', '', 'UploadFiles/vedio/20170803/vedio_8401501724293.png', '0', null, '1501724299');
