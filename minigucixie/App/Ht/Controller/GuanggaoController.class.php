	...
	*/
	public function index(){
		...
		foreach ($adv_list as $k => $v) {
			if ($v['type']=='procat') {
			    $adv_list[$k]['desc'] = '分类商品列表页';
			}else if ($v['type']=='prolist') {
			    $adv_list[$k]['desc'] = '商品列表页';
			}else if ($v['type']=='pro') {
			    $adv_list[$k]['desc'] = '商品详情页';
			}else if ($v['type']=='shoplist') {
			    $adv_list[$k]['desc'] = '商铺列表页';
			}else if ($v['type']=='shop') {
			    $adv_list[$k]['desc'] = '商铺详情页';
			}else if ($v['type']=='join') {
			    $adv_list[$k]['desc'] = '商家入驻页';
			}else if ($v['type']=='vou') {
			    $adv_list[$k]['desc'] = '新人体验区';
			}else if ($v['type']=='tgys') {
			    $adv_list[$k]['desc'] = '团购预售区';
			}else {
				$adv_list[$k]['desc'] = '首页';
			}
		}	
